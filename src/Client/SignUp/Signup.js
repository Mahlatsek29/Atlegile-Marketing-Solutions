...
const Signup = () => {
    ...
    const handleSignup = () => {
        ...
        navigation.navigate('AccountHolder');
    };
        ...
        <ImageBackground source={require('../Global/images/Reed.jpg')} style={styles.background}>
            <View style={styles.container}>
                ...
                <View style={{ width: '120%', flexDirection: 'row', justifyContent: 'space-around' }}>
                    ...
                    {/*Insert arrow logo */}
                    <Text style={{ fontSize: '70%', marginBottom: '-20%' }}>SHOP <FontAwesome style={styles.arrow} name="angle-right" size={20} color="#072840" /> </Text>
                </View>
                ...
                <TouchableOpacity>
                    <Text style={styles.linkText1}> <AntDesign name="google" size={15} color="red" />SIGN UP WITH GOOGLE</Text>
                </TouchableOpacity>

                <TouchableOpacity style={styles.businessButton} onPress={handleBusinessSignup}>
                    <Text style={styles.buttonText1}>SIGN UP AS A BUSINESS <FontAwesome style={styles.arrow} name="angle-right" size={20} color="#072840" /></Text>
                </TouchableOpacity>
            </View>
        </ImageBackground>
    );
